...
// Generate Random Indian Data (UPDATED WITH NEW NAMES & DETAILS)
void initializeData() {
    // UPDATED: New list of names
    string names[] = {"Venkatesh", "Sai Pallavi", "Harsha", "Deepika", "Manoj", "Keerthi", "Abhinav", "Swathi", "Tarun", "Lakshmi"};
    
    // UPDATED: Changed to Odd semesters for variety
    int semOptions[] = {1, 3, 5, 7};
    ...
    for (int i = 0; i < numNames; i++) {
        ...
        double cgpa = 5.5 + (rand() % 45) / 10.0; // UPDATED: Random between 5.5 and 10.0
        
        // Generate Email
        string mail = n + "@srmap.edu.in"; // UPDATED: Domain variation
